...
public class TopNHelpfulReviewCombiner extends Reducer<Text, Text, Text, Text> {
    ...
    protected void reduce(Text key, Iterable<Text> values, Context context) throws IOException, InterruptedException {
        ...
        for (TopNHelpfulReviewsWritable t : sortedMap.values()) {
            Text text = TextParser.HSeparatedString(t.getMarketPlace(), t.getCustomerId(), t.getReviewId(),
